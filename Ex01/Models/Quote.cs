...
namespace LaboWeek2.Models
{
    public class Quote
    {
        ...
        //extra (calculated property toevoegen: dit is een property die enkel uit een GET bestaat en iets teruggeeft op basis van de andere properties
            ...
            get
            {
                switch (this.Subject)
                {
                    case "Programming":
                        ...
                        break;
                    case "Hardware":
                        return "https://i.pinimg.com/736x/fa/1e/b7/fa1eb7cd0dc2a72945148603738e514a.jpg";
                        break;
                    case "Windows":
        ...
        //constructor
        //dit is de default constructor (zonder parameters)
        public Quote()
        {
        ...
        //static methodes: methode uit een klasse die zonder een object van die klasse kan aangeroepen worden
        //bv. Quote.GetQuotes()
        ...
        //Deze static methode heeft als parameter de volledige list en een boolean waarde
        //indein de boolean waarde TRUE ---> geeft enkel de anonieme terug
        //indien de boolean waarde FALSE ---> geeft enkel de niet anonieme terug
        public static List<Quote> GetQuotesFiltered(List<Quote> quotes, bool anonymous)
        {
            List<Quote> quotesFiltered = new List<Quote>();
